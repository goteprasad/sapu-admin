...
<html>
    <head>
        ...
        <title>SAPU Admin | Arogya Bank Abhipray</title>
            ...
            <div class="row flex-xl-nowrap">
                ...
                <div class="col-xl-10 col-md-10 col-lg-10 bd-content">
                    <div class="row">
                        <div class="col">
                            <div class="pull-left">
                                <h4 class="m-b-15">आरोग्य बँक अभिप्राय</h4>
                            </div>
                            <div class="pull-right">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">आरोग्य बँक अभिप्राय</li>
                                    </ol>
                                </nav>
                            </div>
