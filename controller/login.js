...
//            });
            ...
            $http({
        method : "GET",
        url : "http://www.hatchers.in/sapu/index.php/api/web_api_v1/login?format=json&mobile="+$scope.mobile+"&password="+$scope.password
        ...
        */
        if(response.data.status==="Success"){
            ...
            $rootScope.mobile=response.data.status[0].mobile;
            window.location.href = 'index.html';
        }
